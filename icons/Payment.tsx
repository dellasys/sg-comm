...
const Payment = ({ size = 14 }: IconProps) => {
  return (
    <Svg x="0px" y="0px" viewBox="0 0 512 512" width={size} height={size}>
      <Path
        fill="#2196F3"
        d="M480,127.992H32c-17.632,0-32,14.368-32,32v288c0,17.664,14.368,32,32,32h448
	c17.664,0,32-14.336,32-32v-288C512,142.36,497.664,127.992,480,127.992z"
      />
      <Rect y="191.992" fill="#455A64" width="512" height="96" />
      <G>
        <Path
          fill="#FAFAFA"
          d="M144,383.992H80c-8.832,0-16-7.168-16-16s7.168-16,16-16h64c8.832,0,16,7.168,16,16
		S152.832,383.992,144,383.992z"
        />
        <Path
          fill="#FAFAFA"
          d="M512,286.264V159.992c0-17.632-14.336-32-32-32H224v32c0,100.224,38.144,161.248,136.192,217.696
		c7.232,4.128,15.488,6.304,23.808,6.304s16.576-2.176,23.904-6.368C456.416,349.752,490.208,320.664,512,286.264z"
        />
      </G>
      <Path
        fill="#009688"
        d="M502.304,81.304l-112-48c-4.064-1.728-8.576-1.728-12.64,0l-112,48
